(()=>{
    ...
    (()=>{
        ...
        __webpack_require__.d(__webpack_exports__, {
            Sector: ()=>/* reexport */ Sector,
            StraightArrow: ()=>/* reexport */ StraightArrow,
            DiagonalArrow: ()=>/* reexport */ DiagonalArrow,
            DoveTailDiagonalArrow: ()=>/* reexport */ DoveTailDiagonalArrow,
            GatheringPlace: ()=>/* reexport */ GatheringPlace,
            ClosedCurve: ()=>/* reexport */ ClosedCurve,
            DoubleArrow: ()=>/* reexport */ DoubleArrow
        });
        const external_maptalks_namespaceObject = maptalks;
        /**
 ...
 */ Point.convert = function(p) {
            if (p instanceof Point) return /** @type {Point} */ p;
            if (Array.isArray(p)) return new Point(+p[0], +p[1]);
            if (void 0 !== p.x && void 0 !== p.y) return new Point(+p.x, +p.y);
 ...
 */ const Coordinate = external_maptalks_namespaceObject.Coordinate;
        const Canvas = external_maptalks_namespaceObject.Canvas;
        /**
 *                  nextNormal
 *    currentVertex    ↑
 *                .________. nextVertex
 ...
 */ function getJoinNormal(normal, nextNormal) {
     ...
     */ const getArrowBody = (vertexes, lineWidth, map, ratio, arrowLength)=>{
            ...
            for(let i = 1, l = vertexes.length; i < l; i++){
                ...
                next = i < l - 1 ? new Point(vertexes[i + 1].x, vertexes[i + 1].y) : null;
     ...
     */ const isObject = (value)=>{
        ...
        const paintSmoothLine = (ctx, points, lineOpacity, smoothValue, draw, close, tailIdx, tailRatio)=>{
            ...
            function path(ctx, points, lineOpacity, fillOpacity, lineDashArray) {
                if (!external_maptalks_namespaceObject.Util.isArrayHasData(points)) return;
 ...
 */ const StraightArrow_options = {
        ...
        class StraightArrow extends external_maptalks_namespaceObject.Curve {
            ...
            _paintOn(ctx, points, segs, lineOpacity, fillOpacity, lineDasharray) {
                ...
                //draw head
                i += segs[0];
                external_maptalks_namespaceObject.Canvas._path(ctx, points.slice(i, i + segs[1]), lineDasharray, lineOpacity);
                //draw body downside
                i += segs[1];
                ...
                external_maptalks_namespaceObject.Canvas._stroke(ctx, lineOpacity);
                external_maptalks_namespaceObject.Canvas.fillCanvas(ctx, fillOpacity, points[0].x, points[0].y);
            }
            _closeArrow(ctx) {
                ctx.closePath();
            }
     ...
     */ _getArrowHead(h1, h2, points, lineWidth, lineRatio, f1, f2, hScale1, hScale2, h1h2Ratio) {
                ...
                const vertex01 = new external_maptalks_namespaceObject.Point((arrowHead[0].x + arrowHead[1].x) / 2, (arrowHead[0].y + arrowHead[1].y) / 2);
                const head0 = this._getArrowHeadPoint(arrowHead[0], arrowHead[1], vertex01, lineWidth * lineRatio, f2, hScale2)[0];
                const vertex21 = new external_maptalks_namespaceObject.Point((arrowHead[2].x + arrowHead[1].x) / 2, (arrowHead[2].y + arrowHead[1].y) / 2);
                ...
                if (2 === points.length) arrowPoints = [
                    ...
                    const controlPoint = new external_maptalks_namespaceObject.Point(besierPoints[besierPoints.length - 1].prevCtrlPoint);
                    ...
                    const headPoint = new external_maptalks_namespaceObject.Point(lastPoint.x + direction.x * h1h2Length * h1h2Ratio, lastPoint.y + direction.y * h1h2Length * h1h2Ratio);
                    arrowPoints = [
                        h1,
                        head0,
                        headPoint,
 ...
 */ StraightArrow.mergeOptions(StraightArrow_options);
        ...
        external_maptalks_namespaceObject.DrawTool.registerMode('StraightArrow', {
            action: [
                'click',
                'mousemove',
                'dblclick'
 ...
 */ DiagonalArrow.mergeOptions(DiagonalArrow_options);
        ...
        external_maptalks_namespaceObject.DrawTool.registerMode('DiagonalArrow', {
            action: [
                'click',
                'mousemove',
                'dblclick'
 ...
 */ const DoveTailDiagonalArrow_options = {
        ...
        class DoveTailDiagonalArrow extends DiagonalArrow {
            ...
            _closeArrow(ctx, last, first) {
                ...
                const m = new Point(t1.x + t2.x, t1.y + t2.y).mult(0.5);
 ...
 */ DoveTailDiagonalArrow.mergeOptions(DoveTailDiagonalArrow_options);
        ...
        external_maptalks_namespaceObject.DrawTool.registerMode('DoveTailDiagonalArrow', {
            action: [
                'click',
                'mousemove',
                'dblclick'
        ...
        class InterpolationGeometry extends external_maptalks_namespaceObject.Curve {
            startEdit() {
                let options = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                options.newVertexHandleSymbol = {
                    markerType: 'ellipse',
     ...
     */ _generate() {
                ...
                const _points = external_maptalks_namespaceObject.Coordinate.toNumberArrays(coordinates);
                ...
                }
                {
                    ...
                    points = points.map((p)=>new external_maptalks_namespaceObject.Coordinate(p));
                }
                return points;
            }
            /**
     ...
     */ getPlotType() {
            ...
            _exportGeoJSONGeometry() {
                const coordinates = external_maptalks_namespaceObject.Coordinate.toNumberArrays([
                    this.getShell()
                ]);
                return {
                    type: 'Polygon',
            ...
            _toJSON(options) {
                const opts = external_maptalks_namespaceObject.Util.extend({}, options);
                const coordinates = this.getCoordinates();
                opts.geometry = false;
     ...
     */ static getSymmetricalPoints(linePnt1, linePnt2, point) {
        ...
        external_maptalks_namespaceObject.DrawTool.registerMode('DoubleArrow', {
            action: [
                'click',
                'mousemove',
                'dblclick'
            ...
            create (projection, prjPath) {
                const path = prjPath.map((c)=>projection.unproject(c));
                const line = new external_maptalks_namespaceObject.LineString(path);
                line._setPrjCoordinates(prjPath);
                return line;
            },
     ...
     */ _generate() {
                ...
                {
                    const points = external_maptalks_namespaceObject.Coordinate.toNumberArrays(coordinates);
                    ...
                    pList = pList.map((p)=>new external_maptalks_namespaceObject.Coordinate(p));
                    return pList;
                }
            }
            _exportGeoJSONGeometry() {
        ...
        external_maptalks_namespaceObject.DrawTool.registerMode('ClosedCurve', {
            action: [
                'click',
                'mousemove',
                'dblclick'
     ...
     */ _generate() {
                ...
                if (3 === count) {
                    ...
                    points = pList.map((p)=>new external_maptalks_namespaceObject.Coordinate(p));
                } else ;
                return points;
            }
            _exportGeoJSONGeometry() {
        ...
        external_maptalks_namespaceObject.DrawTool.registerMode('PlotSector', {
            action: [
                'click',
                'mousemove',
                'dblclick'
            ...
            update (projection, path, geometry, e) {
                ...
                if (layer) {
                    ...
                    if (!sector && path.length >= 3) {
                        ...
                        sector.addTo(layer);
                        const pSymbol = external_maptalks_namespaceObject.Util.extendSymbol(symbol, {});
        ...
        class GatheringPlace_GatheringPlace extends src_InterpolationGeometry {
            ...
            _generate() {
                ...
                let _points = external_maptalks_namespaceObject.Coordinate.toNumberArrays(coordinates);
                if (count < 2) return;
                if (2 === count) {
        ...
        external_maptalks_namespaceObject.DrawTool.registerMode('GatheringPlace', {
            action: [
                'click',
                'mousemove',
                'dblclick'
    ...
    var __webpack_export_target__ = maptalks = 'undefined' == typeof maptalks ? {} : maptalks;
